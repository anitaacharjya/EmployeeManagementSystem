...
<div class="w-64 bg-blue-500 text-white p-6">
    ...
    <nav>
         <ul>
            <li class="mb-4">
                <a href="admin.jsp" class="block py-2 px-4">Dashboard</a>
            </li>
            <li class="mb-4">
                <a href="Department.jsp" class="block py-2 px-4">Department</a>
            </li>
            <li class="mb-4">
                <a href="UserWorkreport.jsp" class="block py-2 px-4">Workreport</a>
            </li>
            <li class="mb-4">
                <a href="EmployeeAttendanceList.jsp" class="block py-2 px-4">Shift</a>
            </li>
            <li class="mb-4">
                <a href="EmployeeList.jsp" class="block py-2 px-4">Employee</a>
            </li>
             <li class="mb-4">
                <a href="AppliedLeave.jsp" class="block py-2 px-4">Leave's</a>
            </li>
            <li class="mb-4">
                <a href="payrollForm.jsp" class="block py-2 px-4">Payroll</a>
            </li>
             <li class="mb-4">
                <a href="payslips.jsp" class="block py-2 px-4">Payslips</a>
            </li>
            <li class="mt-auto">
                <button id="logout-btn" class="block py-2 px-4">Logout</button>
            </li>
        </ul>
    </nav>
</div>
